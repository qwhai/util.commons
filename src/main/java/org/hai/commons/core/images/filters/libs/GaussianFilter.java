...
package org.hai.commons.core.images.filters.libs;
...
public class GaussianFilter extends ConvolveFilter {
     ...
     * @param premultiply [waiting...]
     * @param unpremultiply [waiting...]
	...
	// FIXME - 定位到要模糊图片中某一块区域
	@SuppressWarnings("unused")
    private static void convolveAndTranspose(Kernel kernel, int[] inPixels, int[] outPixels, BlurRectangle rect, int width, int height, boolean alpha, boolean premultiply, boolean unpremultiply, int edgeAction) {
        float[] matrix = kernel.getKernelData( null );
        int cols = kernel.getWidth();
        int cols2 = cols / 2;
