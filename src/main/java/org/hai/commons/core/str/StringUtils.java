...
import org.hai.commons.core.chars.CharUtils;
import org.hai.commons.core.excep.CannotInstanceException;
import org.hai.commons.core.interf.UtilsInterface;
import org.hai.commons.core.nums.RandomUtils;
import org.hai.commons.core.str.match.impl.KMP;
import org.hai.commons.core.str.match.poke.StringMatchUtils;
...
public class StringUtils implements UtilsInterface {
    ...
    public void description() {
        System.out.println("这个是关于字符串相关的工具类");
    }
     ...
     * @version 0.1
     */
    public static class RegexUtils implements UtilsInterface {
        ...
        @Override
        public void description() {
            System.out.println("关于字符串的正则匹配相关的工具类");
        }
