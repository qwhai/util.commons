...
public class NumberUtils implements UtilsInterface {
    ...
    public void description() {
        System.out.println("这个是关于数字相关的工具类");
    }
     ...
     * @version 0.1
     */
    public static class PrimeUtils implements UtilsInterface {
     ...
     * @version 0.1
     */
    public static class HexUtils implements UtilsInterface {
