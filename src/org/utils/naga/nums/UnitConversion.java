package org.utils.naga.nums;

import java.util.HashMap;
import java.util.Map;

import org.utils.naga.consts.MemoryUnit;
 ...
 * @version 0.1.1
 */
public class UnitConversion implements UtilsInterface {
    ...
    public void description() {
        System.out.println("你可以通过我来做一些单位上的智能转换");
    }
     ...
     * @version 0.1
     */
    public static class TimeUtils implements UtilsInterface {
