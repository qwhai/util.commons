 ...
 * @version 0.1.1
 */
public class ArithUtils implements UtilsInterface {

    // 禁止实例化
    private ArithUtils() throws CannotInstanceException {
    ...
    public void description() {
        System.out.println("这是一个数值运算的工具类，处理一些数值的计算，比如加、减、乘、除等");
    }
