...
import org.core.utils.cipher.interf.CipherWithKey;
 ...
 * @version 0.1.2
 */
public final class SMS4Impl implements CipherWithKey {
    ...
    public void description() {
        System.out.println("SMS4加密策略实现");
    }

    @Override
    public byte[] encryption(String plaintext, byte[] key)
    ...
    @Override
    public String decryption(byte[] ciphertext, byte[] key)
            throws IrreversibleException, StrategyException {
